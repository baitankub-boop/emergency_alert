...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    notify_template_hint: "Raw JSON sent to the provider's API. Use {{type}}, {{floor}}, {{description}}, {{email}}, {{status}}, {{timestamp}}, {{remark}} as placeholders. {{remark}} is only filled in when staff add/change a remark.",
  ...
  th: {
    ...
    notify_template_hint: "JSON ดิบที่จะส่งไปยัง API ของผู้ให้บริการ ใช้ {{type}}, {{floor}}, {{description}}, {{email}}, {{status}}, {{timestamp}}, {{remark}} เป็นตัวแปรได้ ({{remark}} จะมีค่าเมื่อเจ้าหน้าที่เพิ่ม/แก้ไขหมายเหตุเท่านั้น)",
