...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    notify_template_hint: "Raw JSON sent to the provider's API. Use {{type}}, {{floor}}, {{description}}, {{email}}, {{status}}, {{timestamp}} as placeholders.",
  ...
  th: {
    ...
    hero_title: "ระบบแจ้งเหตุฉุกเฉินและขัดข้อง กรณีศึกษา อาคาร 40 ปี มจพ.",
    ...
    notify_template_hint: "JSON ดิบที่จะส่งไปยัง API ของผู้ให้บริการ ใช้ {{type}}, {{floor}}, {{description}}, {{email}}, {{status}}, {{timestamp}} เป็นตัวแปรได้",
