    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
          ...
          <p className="text-red-600 text-sm text-center font-medium mb-2 break-all">{email}</p>
          ...
          <div className="flex gap-2 sm:gap-3 justify-center mb-6" onPaste={handlePaste}>
            {otp.map((digit, index) => (
              <input
                ...
                className="w-11 h-14 text-center text-xl font-bold bg-white border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-red-400/50 focus:border-red-400 transition-all duration-200 caret-transparent"
              />
            ))}
          </div>
          ...
          <div className="text-center">
            <button
              ...
              className="text-sm text-slate-400 hover:text-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {resendCooldown > 0
